...
export default function SaveTheDate() {
    ...
    const fetchProjects = () => {
        ...
        getEmployeeProjectsByType(employeeId, 'Save the Date')
            .then(res => {
            ...
            .catch(err => console.error('SaveTheDate projects fetch error', err))
    ...
    return (
        <div className="space-y-6 max-w-7xl animate-in zoom-in-95 duration-300">
            {!selectedProject ? (
                <>
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 mb-1 font-sans">Save the Date Workspace</h1>
                        <p className="text-sm text-gray-500 font-medium">Manage and design your accepted Save the Date projects</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="bg-purple-50/50 p-4 rounded-2xl mb-6">
                                    <p className="text-[13px] text-gray-700 font-medium leading-relaxed">
                                        {selectedProject.admin_notes || "Create a cinematic 'Save the Date' video. Please follow the standard 1-minute romantical template. Emphasize slow-motion clips and warm color grades."}
                                    </p>
                                </div>
                            </div>
